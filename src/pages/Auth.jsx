...
export default function Auth() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      toast.success(role === 'vendor' ? 'Vendor account created! Pending approval.' : 'Account created successfully!');
      navigate('/');
    } catch (error) {
      toast.error(error.message);
    } finally {
      ...
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-500">
            {isLogin ? 'Log in to your account to continue' : 'Join our marketplace today'}
          </p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all outline-none appearance-none"
              >
